...
- **Phase completed:** Phase 0 — scaffolding green
- **Next unbuilt slice:** Phase 1 — Connector interface + MockCloudConnector
- **Known issues / TODOs:**
  - `packages/db` seed uses `_SentinelMeta` placeholder; replace with real graph models in Phase 2.
  - No auth yet (Phase 8).
